...
function checkAnswer(e){
  if(e.keyCode == 13){
    ...
    lastQuestion = Q[Q.length - 1];
    // console.log("last answer:", trueA[trueA.length-1]);
    ...
    // console.log(Number(a.value), a.value, typeof a.value);
    // if (isNaN(a.value)){
    //   console.log("not a number");
    //   var tempUserIn = a.value.replaceAll(' ', '');
    //   console.log('temp1:', tempUserIn);
    //   var tempUserIn = tempUserIn.replace('G', '000000000');
    //   console.log('temp2:', tempUserIn);
    //   var tempUserIn = tempUserIn.replace('M', '000000');
    //   console.log('temp3:', tempUserIn);
    //   var tempUserIn = tempUserIn.replace('k', '000');
    //   console.log('temp4:', tempUserIn);
    //   var tempUserIn = a.value.replaceAll('.', '');
    //   console.log('temp5:', tempUserIn);
    //   var userIn = tempUserIn;
    // } else {
    //   var userIn = a.value;
    // }
    // console.log("User Input:", userIn, 'temp:', tempUserIn); // Log user input
    // console.log("Correct Answer:", answer); // Log correct answer
    userA.push(a.value);
    trueA.push(answer);
    // console.log("this answer:", trueA[trueA.length-1]);
